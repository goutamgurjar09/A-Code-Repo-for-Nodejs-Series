...
router.get('/products/:id',async(req,res)=>{
   try{
    ...
    //  res.render('show',{foundProduct , msg:req.flash('msg')});   //req ke flash ke ander 'msg' key se jo bhi message mile use (msg:) me store kr do    ->show page pr hmne pura Product ko render/bhej diya  and hm jb review add krege to msg bhi show ise page pr hoga-> see review.js
    res.render('show', { foundProduct, success: req.flash('success')});
