...
router.post('/products/:id/rating',validateReview,async(req,res)=>{
    ...
    try{
       ...
       // req.flash('msg','Review Added Successfully'); // then isko hme  show.ejs me show krna hai jis page pr ye redirect ho rha  first see-> product.js then go -> show.ejs
        req.flash('success','Review Added Successfully');  //uper bale ki jgh ab hm iska use krege
