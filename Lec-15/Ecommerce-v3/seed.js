//seed.js se saman/products ko hm database me dalege  means assume hmare pass 4-5 product hai and inko hme ek sath bhejna hai apne DB ke ander to hm ise seeding bolte hai
...
async function seedDB(){
   await Product.insertMany(products)//seedDB-> insert array of obj in DB means Product name ki collection ye sare products ko add kr dega me  and ye insertMany returns krta hai ek promise isliye async and await ki help se inhe resolve krte hai
   console.log("DB seeded")
}
module.exports = seedDB  //so that hm ise dusre jgh istemaal kr ske
